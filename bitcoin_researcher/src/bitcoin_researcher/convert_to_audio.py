...
load_dotenv(Path("bitcoin_researcher/.env"))
load_dotenv()
from pathlib import Path
...
with open('/home/gemac/Desktop/swarm-crewai-agents/swarm-crewai-agents/bitcoin_researcher/analyzes_pt-br.md', 'r', encoding='utf-8') as file:
    string = file.read()
